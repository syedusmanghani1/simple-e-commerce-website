...
{/* bottom */}
    ...
    <p className="text-sm text-[#9DA0AE] sm:ml-6 sm:mt-0 mt-4">
     ...
     <div className="w-5 h-5 " ><a href="https://www.facebook.com/" target="_blank"><FaFacebook  /></a></div> 
      <div className="w-5 h-5  ml-3 text-gray-900"><a href="https://www.instagram.com/" target="_blank"><RxInstagramLogo /></a></div>
        <div className="w-5 h-5  ml-3 text-gray-900"><a href="https://pk.linkedin.com/" target="_blank"><FaLinkedin  /></a></div>
